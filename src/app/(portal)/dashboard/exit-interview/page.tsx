...
export default function ExitInterviewPage() {
  ...
  if (existing?.status === "Submitted") return (
    <div className="flex flex-col items-center justify-center py-24 space-y-6 animate-fade-in-up">
      <div className="w-20 h-20 rounded-full bg-[#1E6DEB]/10 flex items-center justify-center">
        <CheckCircle className="w-10 h-10 text-indigo-400" />
      </div>
      <h2 className="text-2xl font-extrabold tracking-tight">Exit Interview Submitted</h2>
  ...
  return (
    <div className="space-y-8 animate-fade-in-up max-w-2xl">
      <div>
        <h1 className="text-3xl font-extrabold tracking-tight text-[#111827] tracking-tight font-extrabold">Exit Interview</h1>
      ...
      <div className=" rounded-3xl p-8 border border-white/5">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-3 p-4 rounded-[24px] bg-muted/30 border border-white/10">
